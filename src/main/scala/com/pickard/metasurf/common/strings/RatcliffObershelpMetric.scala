package com.pickard.metasurf.common.strings

;

case object RatcliffObershelpMetric {
  ...
  private def longestCommonSubsequence(ct: (Array[Char], Array[Char])) = {
  ...
  private val commonSequences: ((Array[Char], Array[Char])) => Array[Array[Char]] = (ct) => {
